...
export default function Topheader(){
    return(
       <main>
<div className="flex justify-center items-center bg-[#2A254B] text-[#FAFAFA] h-5 text-[8px] w-screen  pl-4 md:gap-20 md:text-sm md:h-12 lg:gap-36 lg:pl-40 xl:gap-[231px] xl:pl-80" >
